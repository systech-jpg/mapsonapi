{{-- Satu layar penuh: header di atas, daftar pesan menggulir di tengah, kotak
     tulis menempel di dasar. Dulu kotak tulisnya cuma position: sticky, dan
     sticky hanya menempel kalau isinya SUDAH lebih tinggi dari layar — pada
     percakapan yang baru berisi satu-dua pesan, kotaknya berhenti di tengah
     layar. --}}
<div class="ch-layar">
  ...
  <div class="ch-isi">
    ...
    @forelse ($pesan as $p)
      ...
      @if ($tanggal !== ($tanggalTerakhir ?? null))
...
@script
<script>
  // Yang menggulir sekarang KOTAK daftar pesan, bukan halaman: seluruh layar
  // setinggi viewport dan tidak pernah ikut bergulir. window.scrollTo() di sini
  // tidak akan menggerakkan apa pun.
  const keBawah = () => {
    const kotak = document.querySelector('.ch-isi');
